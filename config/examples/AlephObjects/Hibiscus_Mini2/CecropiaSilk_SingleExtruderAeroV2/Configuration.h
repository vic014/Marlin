...
#define LULZBOT_LEFT_PROBE_BED_POSITION -3 // <-- changed
#define LULZBOT_RIGHT_PROBE_BED_POSITION 163 // <-- changed
#define LULZBOT_BACK_PROBE_BED_POSITION 168 // <-- changed
#define LULZBOT_FRONT_PROBE_BED_POSITION -4 // <-- changed
