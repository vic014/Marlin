...
void AdvancedSettingsMenu::onRedraw(draw_mode_t what) {
  if (what & BACKGROUND) {
    ...
    cmd.cmd(CLEAR_COLOR_RGB(Theme::bg_color))
      ...
      #endif
      #define GRID_COLS 2
      #define RESTORE_FAILSAFE_POS    BTN_POS(1,1), BTN_SIZE(2,1)
      ...
      #define RESTORE_FAILSAFE_POS    BTN_POS(1,6), BTN_SIZE(2,1)
  ...
  if (what & FOREGROUND) {
    ...
    cmd.colors(normal_btn)
      ...
      .tag(10).button( RESTORE_FAILSAFE_POS,   GET_TEXT_F(MSG_RESTORE_FAILSAFE))
